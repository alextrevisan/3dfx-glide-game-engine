...
##FLAGS
CFLAGS:= -march=pentium-mmx -Wall -m32 -std=c++1z -fexceptions -fpermissive -fomit-frame-pointer -O3
...
#LIBS
CLIBS = -static-libstdc++ -static-libgcc -static -m32  -lmingw32 3rd\lib\libSDLmain.a 3rd\lib\libSDL.dll.a -luser32 -lgdi32 -lwinmm -limm32 -lwinspool -lshell32 -lole32 -loleaut32 -lversion -luuid -lcomdlg32 -ladvapi32 -lkernel32
